    ...
    return (
        <header className="header flex justify-between ">
            <div className="icons-container flex items-center ">
                <button className="p-2 rounded-full option" title={'Historial de partidos'}>
                    <i className="fas fa-clock-rotate-left text-white"></i>
                </button>
                <button className="p-2 rounded-full option" title={'Partidos'}>
                    <i className="fas fa-futbol text-white"></i>
                </button>
                <button className="p-2 rounded-full option" title={'Entrenos'}>
                    <i className="fas fa-person-running text-white"></i>
                </button>
                <button className="p-2 rounded-full option" title={'Universidades'}>
